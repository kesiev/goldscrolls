...
function Docs() {
    ...
    var
        ...
        MarkdownRenderer={
            ...
            formatPortraitBar:(image,name)=>{
                return "<div align=\"center\" style=\"background-color:#fff;margin:60px 0\"><p><img style=\"max-height:150px\" src=\"portraits/" + image+"\"></p></div>\n\n### " + name + "\n\n";
            },
            formatGenerator:(method,pos,name,version)=>{
                return "";
            },
            ...
            addImage:(image)=>{
                return "<div align=\"center\" style=\"background-color:#fff;margin:60px 0\"><p><img style=\"max-height:450px\" src=\"images/" + image +"\"></p></div>\n\n";
            }
        };
